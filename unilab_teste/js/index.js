document.addEventListener("DOMContentLoaded", function () {
    ...
    class AssistenteVirtual {
        ...
        startInactivityCheck() {
            ...
            this.inactivityTimer = setInterval(() => {
                ...
                // Se passaram mais de 5 segundos sem interação e o chat não estiver aberto
                if (timeSinceLastInteraction > 5000 && !this.isOpen) {
                    this.openChat();
    ...
    // Iniciar o monitoramento de inatividade após alguns segundos
    // para dar tempo do usuário começar a interagir com a página
    setTimeout(() => {
        assistente.startInactivityCheck();
    }, 10000); // Começar a monitorar inatividade após 10 segundos

    // Abrir o assistente automaticamente após o carregamento da página
    setTimeout(() => {
        assistente.openChat();
    }, 1000);
