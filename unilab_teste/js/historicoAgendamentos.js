...
document.addEventListener('DOMContentLoaded', function() {
    ...
    novoAgendamentoBtn.addEventListener('click', handleNovoAgendamento);
    ...
    function handleNovoAgendamento() {
        const userRole = localStorage.getItem('userRole');
        if (userRole === 'professor') {
            window.location.href = 'agendamentoProfessor.html';
        } else {
            window.location.href = 'agendamentoAdministrador.html';
        }
    }
